...
class Pos:
    ...
    def Position_D(self, L_x, H_x, L_y, H_y):
        self.img_L_x.append(L_x)
        self.img_L_y.append(L_y)
        self.img_width.append(H_x-L_x)
        self.img_height.append(H_y-L_y)
        #self.img_H_x.append(H_x)
        #self.img_H_y.append(H_y)
...
def draw_bounding_box_on_image(image,
  ...
  position_data.Position_D(left, right, top, bottom)
